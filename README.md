...
|----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------|
| `genome_file`              | Path to the genome file                                                                                                                                                                      | results/genome/CLAJMH5.genome.fa.gz          |
| `genome_file_md5`          | Checksum of the archive of the genome file                                                                                                                                                   | db2cd4eff6d40c463998851f43b15670             |
